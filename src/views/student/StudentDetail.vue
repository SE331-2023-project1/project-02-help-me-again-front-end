    ...
    <div class="student-class flex flex-col items-center justify-center">
      <div class="grid gap-5 grid-cols-2 p-3 w-3/4 h-4/5 border border-gray-700
        ...
        <div class="flex justify-center">
          <img :src="student?.images[0]" alt="" class="crop rounded-lg" />
        </div>
        <div class="">
          #{{ student.id }} <br>
          <span class="text-base text-gray-500 font-pri">Student ID: {{ student?.username }}</span> <br />
          <span class="font-pri name font-bold text-black"> {{ student?.firstName }} {{ student?.lastName }}</span>
          ...
          <br>
          <span class="text-lg font-bold mb-2"> Advisor: </span><br>
          ...
          <RouterLink :to="{ name: 'advisor-detail', params: { id: student.advisor.id } }">
            ...
            font-bold py-2 px-5 rounded-xl font-pri hover:transform hover:scale-[1.05] transition-transform duration-300">
              <div class="flex justify-center items-center">
                <img :src="advisor?.images[0]" class="w-10 h-10 object-cover rounded-full mr-2">
