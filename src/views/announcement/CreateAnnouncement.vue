    ...
    <main class="flex flex-col items-center justify-center">
        ...
        <div
            ...
            <div class="flex items-center space-x-3">
                <img :src="advisor?.images" alt="Person's Photo" class="w-20 h-20 rounded-full">
                <div>
                    <p class="font-fig font-semibold text-md">{{advisor?.name}}</p>
...
onMounted(async () => {
    try {
        const response = await useAdvisorStore().getAdvisor()
